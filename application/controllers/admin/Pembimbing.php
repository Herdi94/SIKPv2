...
//add html for action
            $row[] = '<a class="btn btn-sm btn-danger" href="javascript:void(0)" title="delete" onclick="delete_pembimbing('."'".$pembimbing->id_pembimbing."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
