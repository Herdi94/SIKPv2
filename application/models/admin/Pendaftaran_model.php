...
{
 var $table = 'pengaju';
    var $column_order = array('kode_pengajuan','no_identitas','nama','sekolah','jns_pengaju','tgl_mulai','tgl_akhir','photo',null);
    var $column_search = array('no_identitas','nama','sekolah','jns_pengaju');
