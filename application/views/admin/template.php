...
<head>
    ...
    <!--library for include data table and jquery -->
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="<?php echo base_url('upload/'.$this->session->userdata('photo'));  ?>" width="65px" height="60px" alt="User" onerror="this.src='<?php echo base_url('images/error_photo.gif'); ?> '" />
            </div>
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a href="<?php echo site_url('dashboard/save_password'); ?>"><i class="material-icons">lock</i>Change Password</a></li>
                        <li role="seperator" class="divider"></li>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2017 <a href="http://diskominfo.jabarprov.go.id/">Dinas Komunikasi dan Informatika <br> Jawa Barat</a>
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
