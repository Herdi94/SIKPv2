        ...
        <div class="row clearfix">
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="card">
                    ...
                    <tr>
                        <td width="10%">Bidang</td><td><?php echo $this->session->userdata('bidang') ?></td>
                    </tr>

                    <tr>
                        <td width="10%">Jabatan</td><td><?php echo $this->session->userdata('jabatan') ?></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        if (save_method == 'edit') {
            url = "<?php echo site_url('bimbing/pembimbing/ajax_update_profile')?>";
        }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form">
                        <form action="#" id="form" class="form-horizontal">
                            <input type="hidden" value="<?php echo $this->session->userdata('id_pembimbing') ?>" name="id_pembimbing"/>
                            <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="bidang" name="bidang"
                                                       value="<?php echo $this->session->userdata('bidang') ?>"
                                                       class="form-control"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="jabatan" name="jabatan"
                                                       value="<?php echo $this->session->userdata('jabatan') ?>"
                                                       class="form-control"
