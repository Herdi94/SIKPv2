        ...
        <!-- Widgets -->
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Pendaftaran</div>
                        <div class="number count-to" data-from="0" data-to="200" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Terdaftar</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Disetujui</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Ditolak</div>
                        <div class="number count-to" data-from="0" data-to="10" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
