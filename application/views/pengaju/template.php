...
<head>
    ...
    <title>Kerja Praktek Online</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/form/font-awesome/css/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/form/css/form-elements.css'); ?>">
    ...
    <link rel="shortcut icon" href="<?php echo base_url('assets/images/jabar.png') ?>">


    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url('assets/startbootstrap_freelancer/vendor/bootstrap/css/bootstrap.min.css') ?>"
          rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<?php echo base_url('assets/startbootstrap_freelancer/css/freelancer.min.css') ?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo base_url('assets/startbootstrap_freelancer/vendor/font-awesome/css/font-awesome.min.css') ?>"
          rel="stylesheet">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="page-scroll">
                    <a href="#portfolio">Alur Pendaftaran</a>
                </li>
                <li class="page-scroll">
                    <a href="#about">Pendaftaran</a>
                </li>
                <!--
                <li class="page-scroll">
                    <a href="<?php //echo site_url('pengaju/email') ?>">Email</a>
                </li>
                <li class="page-scroll">
                    <a href="<?php //echo site_url('pengaju/welcome/konfirmasis') ?>">Konfirmasi</a>
                </li>
                -->
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="intro-text">
                    ...
                    <hr class="star-light">
                    <font size="4"><span class="skills">Selamat Datang di Kerja Praktek Online</span></font>
        ...
        <div class="row">
            <div class="col-sm-4 portfolio-item">
                <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('assets/images/alur.jpg'); ?>" class="img-responsive" alt="">
                </a>
            </div>
</section>
            ...
            <div class="form-box">
                <div class="form-top">
                    <div class="form-top-left">
                        ...
                        <p>Silahkan isi form pengajuan kerja praktek dengan lengkap dan benar.</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="container">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <?php echo form_label('Jenis Pengaju', ''); ?>
                                        <?php $option = array(
                                            "" => "--Pilih jenis pengaju--",
                                            "Personal" => "Personal",
                                            "Kelompok" => "Kelompok"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_label('Anggota Kelompok (pilihan)', ''); ?>
                                        <?php echo form_textarea('anggota_kelompok', set_value('anggota_kelompok'), array("id" => "anggota_kelompok", "class" => "form-control")); ?>

                                        <?php echo form_label('*Ketentuan jika memilih jenis pengaju kelompok maka diharuskan
mencantumkan nim beserta nama semua anggota kelompok contoh :<br><br>
Format: (nim nama) -> 10113732 Herdi Zulfiqri, 10346789 Bagus Rajo
', ''); ?>

                                    </div>

                                    <div class="form-group">
                                        <?php echo form_label('Jenjang Pendidikan', ''); ?>
                                        <?php $option = array(
                                    ...
                                    <div class="form-group">
                                        <?php echo form_label('Rencana Kerja Praktek/PKL', ''); ?>
                                        <div class="form-group">
                                        ...
                                        <br>
                                        <br>
                                        <?php echo form_label('*Ketentuan waktu pelaksanaan kerja praktek antara lain :
<br>
a. 1 bulan contoh : 2016-10-10 - 2016-11-10<br>
b. 2 bulan contoh : 2016-10-10 - 2016-12-10<br>
c. 3 bulan contoh : 2016-10-10 - 2017-01-10<br>', ''); ?>


                                        <!--for show preview photo -->
                                        <script type="text/javascript">
                                        ...
                                        <div class="form-group">
                                            <?php echo form_label('<br>Silahkan upload surat kerja praktek/PKL <br>Format image : jpeg/jpg/dll', ''); ?>
...
<div class="form-group">
    <?php echo form_submit('submit', 'Submit', array("class" => "btn-primary btn-lg")); ?>
</div>
...
<footer class="text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="footer-col col-sm-5">
                    ...
                    <p>Jalan Tamansari No.55
                        <br>Telepon (022) 2502898
                        <br>Fax-(022) 2511505
                        <br>email : diskominfo@jabarprov.go.id</p>
                </div>

                <div class="footer-col col-sm-6">
                    <h4>Dinas Komunikasi dan Informatika Jawa Barat</h4>
                    <img src="<?php echo base_url('assets/images/jabar.png'); ?>" width="25%" height="100">
                </div>
            </div>
        </div>
    </div>
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    Copyright &copy; Dinas Komunikasi dan Informatika Jawa Barat 2016
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/startbootstrap_freelancer/vendor/bootstrap/js/bootstrap.min.js') ?>"></script>
